...
//MARK: -Helper Properties
    ...
    private enum Mark: String, Equatable {
        ...
        var turnString: String  {
            ...
            case .empty: return "Player X's turn"
...
//MARK: - Test Setup
    ...
    // by giving references in the storyboard we will do this part of the storyboard
        
        app.buttons["button1"].staticTexts[" "].tap()
        XCUIApplication()/*@START_MENU_TOKEN@*/.staticTexts["GameViewController.TurnLabel"]/*[[".staticTexts[\"Player O's turn\"]",".staticTexts[\"GameViewController.TurnLabel\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        app.buttons["button4"].staticTexts[" "].tap()
        app.buttons["button7"].tap()
        app.buttons["button2"].staticTexts[" "].tap()
        app.buttons["button5"].staticTexts[" "].tap()
        
        XCTAssertEqual(app.staticTexts["GameViewController.TurnLabel"].label, "Player X Won!")
    }
